...
### Links??
Now I was having issues with links. Trying to link to `xaringan` slides was completely broken, and I couldn't quite figure out why. I thought it was something to do with not understanding my directory structure, and maybe that WAS it. To be honest, I have never figured out what exactly was going on.

Anyway, after proverbially banging my head on everything in sight and getting completely muddled, I opted to start from scratch and write a "new" blogpost. I did some digging and found that it was comparatively easy to link to html files by their "slug" (this is probably widely known information, but it was new to me!). So, I made a new post, added some things to my `config.toml` file (thanks, [Stack Overflow](https://stackoverflow.com/questions/55930617/linking-to-another-post-in-blogdown)!), and hey presto! I could link to html files in my static folder incredibly easily, and could finally include my slides on my site- which was my main reason for starting this journey in the first place.